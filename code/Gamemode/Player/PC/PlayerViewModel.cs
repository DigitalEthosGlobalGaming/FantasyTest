...
namespace FantasyTest
{
	partial class PlayerViewModel : BaseViewModel
	{
		...
		public override void PostCameraSetup( ref CameraSetup camSetup )
		{
			...
			var wep = (Owner as Player).ActiveChild as PlayerWeaponBase;
			var isReloading = wep.IsReloading;
			var isDucking = Owner.LifeState == LifeState.Alive && ((Owner as GameBasePlayer).Controller is FantasyPlayerController a) && a.Duck.IsActive;
			var isSprinting = Owner.LifeState == LifeState.Alive && ((Owner as GameBasePlayer).Controller is FantasyPlayerController b) && b.IsSprinting;
